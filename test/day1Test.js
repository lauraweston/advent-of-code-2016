...
describe("integration - shortest distance", () => {
    const testCases = [
        ["", 0],
        ["R2, L3", 5],
        ["R2, R2, R2", 2],
...
describe("integration - shortest distance to first ", () => {
    const testCases = [
        ["R1, R1, R1, R1", 0],
        ["R2, R1, R1, R2", 1],
        ["R8, R4, R4, R8", 4],
    ...
    testCases.forEach(tc => {
        it("calculates shortest distance correctly", () => {
            ...
            const instructions = parser.parse(input);
            const distance = distanceCalculator.shortestDistanceToFirstIntersection(instructions);
